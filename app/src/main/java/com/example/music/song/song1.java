...
import com.example.music.service.MediaService2;
...
public class song1 extends AppCompatActivity implements View.OnClickListener,
    ...
    private MediaService2.MusicController mMusicController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this, MediaService2.class);
...
//        discAnimation.start();
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        mMusicController = ((MediaService2.MusicController) service);
    }
