...
import com.example.music.service.MediaService1;
...
public class song extends AppCompatActivity implements View.OnClickListener,
    ...
    private MediaService1.MusicController mMusicController;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent intent = new Intent(this, MediaService1.class);
        ...
        myDatabaseHelper=new MyDatabaseHelper(song.this);
    }
    ...
    public void onClick(View v) {
        ...
        switch (id) {
            ...
            case R.id.img:
                ...
                if (isCheck) {
                    Coll = null;
                    img.setImageResource(R.mipmap.shouchang1);
                    myDatabaseHelper.Colladd(Coll);
                } else {
                    img.setImageResource(R.mipmap.shoucang);
                    myDatabaseHelper.Colldelete(Coll);
...
//===================================播放歌曲服务开启、停止、结束===============================
    ...
    public void onServiceConnected(ComponentName name, IBinder service) {
        mMusicController = ((MediaService1.MusicController) service);
    }
